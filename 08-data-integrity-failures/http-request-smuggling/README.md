...
<!-- prerequisites: chạy tests/test_verified_payloads.py trong repo local -->
...
<!-- evidence: tests/test_verified_payloads.py::VerifiedPayloadTests.test_http_framing_fixture_is_bounded_and_rejected -->
<!-- sources: S6 -->
