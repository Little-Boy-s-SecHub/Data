...
Request dưới đây có framing hợp lệ và chỉ dùng dữ liệu synthetic. Chỉ gửi request tới Nginx/app/mail catcher trên loopback hoặc container network cô lập; không gửi email hay request ra Internet. [S3]
