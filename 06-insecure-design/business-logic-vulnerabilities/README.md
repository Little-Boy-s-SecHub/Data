...
> **Lưu ý mapping:** CWE-840 là category “Business Logic Errors”, không phải weakness root-cause cụ thể. Metadata để `cwe: []`; từng lỗi nghiệp vụ phải map theo invariant bị phá vỡ và weakness thực tế.
