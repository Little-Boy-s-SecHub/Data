...
Payload dưới đây chỉ áp dụng cho input fixture và ngữ cảnh đã mô tả; nó không chứng minh mọi ứng dụng Flask đều có lỗi. Chỉ gửi input này tới fixture local có tài khoản và database synthetic. [S3]
