...
> **Gate kỹ thuật:** các nguồn cần được đối chiếu trực tiếp cho từng claim trước khi đổi `content_status` sang `verified`: [S2], [S3], [S4], [S5].
...
Các probe dưới đây vẫn ở `static-verified`; parser và thứ tự duplicate phải được ghi từ đúng fixture thay vì suy đoán. [S2] [S3]
